...
var LEADS_STATUS = ['חדש', 'לא ענה 1', 'לא ענה 2', 'לא ענה 3', 'הצעה נשלחה', 'נסגר ✅', 'לא רלוונטי'];
var LEADS_COLORS = {
  'חדש': '#cfe2f3', 'לא ענה 1': '#fce5cd', 'לא ענה 2': '#f9cb9c', 'לא ענה 3': '#f4cccc',
  'הצעה נשלחה': '#d9d2e9', 'נסגר ✅': '#d9ead3', 'לא רלוונטי': '#efefef'
};
