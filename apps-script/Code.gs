...
const CRM_TRACK_MAP = {
  'חודש ניסיון':        ['חודש ניסיון',  390, 1],
  'מסלול 3 חודשים':     ['3 חודשים',     340, 3],
  'מסלול 8 חודשים':     ['8 חודשים',     290, 8],
  'מסלול 6 חודשים':     ['6 חודשים',     308, 6],   // מותאם: 1850 ₪ ל-6 חודשים (~308/חודש)
  'מסלול ללא התחייבות': ['ללא התחייבות', 390, 0]   // 0 = בלי תאריך סיום
};
