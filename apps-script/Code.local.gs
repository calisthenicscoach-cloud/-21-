...
const KIT_MESSAGE =
  ...
  '\n' +
  'המסלול שלך מתחיל עכשיו.\n' +
  'אתה מתחיל בתור טירון ביחידה, ותצטרך לעבור מבחנים כדי לעלות בדרגות, ולהפוך לבוגר היחידה.\n' +
  'המסע לא יהיה קל, אבל אתה תבנה אופי חזק, התמודדות עם כל אתגר, תבנה את גוף החלומות, ויכולות קליסטניקס מטורפות.\n' +
  '\n' +
  'כדי שתבין בדיוק איך המסלול והאימונים עובדים, הכנתי סרטון מפורט ש*חובה* לצפות בו לתחילת התהליך👇\n' +
  'https://youtu.be/PIe0jIqBB0M\n' +
  '\n' +
  '📲 הצטרף לקבוצת יחידת הקליסטניקס 👇\n' +
  'https://chat.whatsapp.com/FsyBAKToBhF3dWEep1mLMD\n' +
  'זה לא פחות חשוב! בקבוצה אני מפרסם עדכונים חשובים וקובע מפגשי מתאמנים. אל תישאר מחוץ ליחידה — הצטרף עכשיו.\n' +
  '\n' +
  '⚠️ חשוב מאוד\n' +
  'בשביל לקבל את המקסימום ולהתקדם בצורה הכי יעילה, ולמזער סיכון לפציעה וחוסר התקדמות,\n' +
  'חשוב שתצלם סרטונים מהאימונים — בהתחלה לפחות סט ראשון בכל תרגיל,\n' +
  'כדי שנוכל לראות שאתה עושה כמו שצריך, לתת דגשים שמתאימים אלייך ספציפית, ולתת את התיקונים הנדרשים.\n' +
  'כמובן שלכל שאלה והתייעצות אנחנו פה בשבילך.\n' +
  '\n' +
  'וזה עוד לא הכל — ריכזתי לך במקום אחד את כל ערכת הפתיחה:\n' +
  '🎓 קורס תזונה פרקטי – איך להתנהל תזונתית בחיים ובצבא.\n' +
  '🎯 מאגר התוכן של היחידה – סרטוני העשרה, ספרים דיגיטליים, כלים מנטליים ועוד.\n' +
  'הדף הזה הוא הבסיס שלך – תחזור אליו מתי שצריך, הוא ילווה אותך כל הדרך.\n' +
